...
jest.mock(
  '../../../../../../src/modules/auth/interfaces/http/middlewares/auth.middleware',
  () => ({
    buildAuthMiddleware: (sessionStore: unknown, tokenService: unknown) =>
      (mockBuildAuthMiddleware as unknown as (
        a: unknown,
        b: unknown,
      ) => unknown)(sessionStore, tokenService),
  }),
);

jest.mock(
  '../../../../../../src/modules/auth/interfaces/http/middlewares/csrf-protection.middleware',
  () => ({
...
jest.mock(
  '../../../../../../src/modules/auth/interfaces/http/auth.controller',
  () => ({
...
import { buildAuthRouter } from '../../../../../../src/modules/auth/interfaces/http/auth.routes';
